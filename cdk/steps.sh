...
# directory name must be cdk-app/ to go with the rest of the steps, changing it will cause an error
mkdir cdk-app
cd cdk-app/
...
# 2. copy the content of cdk-app-stack.js into lib/cdk-appstack.js
